<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Docs.aspx.cs" Inherits="BMBHviews.ViewDocument" %>
...
<asp:UpdatePanel ID="updatePanelAttachments" runat="server" ChildrenAsTriggers="true"> 
            ...
            <asp:TemplateField>
                <ItemTemplate>
                    ...
                    <ContentTemplate>
                        ...
                        <asp:ImageButton ID="btnPDF" runat="server" ImageUrl="~/Images/pdf_icon.gif" OnClick="btnPDF_Click" ToolTip="PDF analysieren" />
                    </ContentTemplate>
                    <Triggers>
    ...
    <asp:TextBox ID="txtResult" runat="server" Height="500px" TextMode="MultiLine" Width="1000px"></asp:TextBox>
