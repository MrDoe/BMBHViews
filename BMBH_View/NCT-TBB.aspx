<%@ Page Title="NCT-TBB" Language="C#" EnableEventValidation="false" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NCT-TBB.aspx.cs" Inherits="BMBH_View.NCT_TBB" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <asp:Panel ID="Panel1" runat="server">
        <asp:Button ID="btnSearch" runat="server" PostBackUrl="~/NCT-TBB-Search.aspx" Text="Suche" CssClass="btn-pnl" Height="27px" />
        &nbsp;
    ...
    <asp:Panel ID="pnlGrid" runat="server" Height="900px" ScrollBars="Both" HorizontalAlign="Center" BorderColor="White" BorderStyle="Solid" BorderWidth="5px">
        ...
        <asp:SqlDataSource ID="NCT_TBB_View_Sort" runat="server" ConnectionString="<%$ ConnectionStrings:CLIN106_DATAConnectionString %>" SelectCommand="select * from V_NCT_TBB_Gesamt order by InventarID"></asp:SqlDataSource>
        <asp:SqlDataSource ID="NCT_TBB_View" runat="server" ConnectionString="<%$ ConnectionStrings:CLIN106_DATAConnectionString %>" SelectCommand="SELECT * FROM [V_NCT_TBB]"></asp:SqlDataSource>
    </asp:Panel>
    </asp:Content>
