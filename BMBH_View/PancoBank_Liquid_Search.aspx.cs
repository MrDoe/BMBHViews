...
namespace BMBH_View
{
    public partial class PancoBank_Liquid_Search : System.Web.UI.Page
    {
        // constant definitions
        const string sView = "V_PANCOBANK_LIQUID";
        const string sFormTable = "Views_PancoBank_Liquid_Search";
        const string sFormView = "V_PancoBank_Liquid_SearchForm";
        const string sParentPage = "PancoBank_Liquid.aspx";
